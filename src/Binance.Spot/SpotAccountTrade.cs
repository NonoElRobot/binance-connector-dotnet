namespace Binance.Spot
{
    ...
    public class SpotAccountTrade : SpotService
    {
        ...
        public async Task<string> AccountTradeList(
            string symbol,
            long? orderId = null,
            long? startTime = null,
            long? endTime = null,
        ...
        public async Task<string> AllOrders(
            string symbol,
            long? orderId = null,
            long? startTime = null,
            long? endTime = null,
        ...
        public async Task<string> CancelOco(
            string symbol,
        ...
        public async Task<string> NewOco(
            string symbol,
            Side side,
            decimal quantity,
            decimal price,
        ...
        ///     <para />
        ///     - `MARKET` orders using `quoteOrderQty` specifies the amount the user wants to spend (when buying) or receive (when
        ///     selling) of the quote asset; the correct quantity will be determined based on the market liquidity and
        ///     `quoteOrderQty`.
        ///     <para />
        ///     - `MARKET` orders using `quoteOrderQty` will not break `LOT_SIZE` filter rules; the order will execute a quantity
        ...
        /// <param name="newOrderRespType">
        ///     Set the response JSON. MARKET and LIMIT order types default to FULL, all other orders
        ///     default to ACK.
        /// </param>
        /// <param name="recvWindow">The value cannot be greater than 60000.</param>
        ...
        public async Task<string> QueryOco(
            long? orderListId = null,
            string origClientOrderId = null,
            long? recvWindow = null)
        {
